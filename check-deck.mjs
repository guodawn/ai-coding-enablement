...
if (markdownSlides.length !== 39) errors.push(`Markdown has ${markdownSlides.length} slides, expected 39`);
if (htmlSlides.length !== 39) errors.push(`HTML has ${htmlSlides.length} slides, expected 39`);
...
for (let index = 0; index < markdownSlides.length; index += 1) {
  ...
  if (slide.number < 39 && !slide.block.includes("### 过渡")) {
...
console.log(
  `deck check passed: 39 slides, ${visualCount} explanatory visuals, aligned titles, complete notes, self-contained HTML`,
);
