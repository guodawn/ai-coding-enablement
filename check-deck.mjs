...
if (markdownSlides.length !== 31) errors.push(`Markdown has ${markdownSlides.length} slides, expected 31`);
if (htmlSlides.length !== 31) errors.push(`HTML has ${htmlSlides.length} slides, expected 31`);
...
for (let index = 0; index < markdownSlides.length; index += 1) {
  ...
  if (slide.number < 31 && !slide.block.includes("### 过渡")) {
...
console.log(
  `deck check passed: 31 slides, ${visualCount} explanatory visuals, aligned titles, complete notes, self-contained HTML`,
);
