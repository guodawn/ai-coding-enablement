...
if (markdownSlides.length !== 38) errors.push(`Markdown has ${markdownSlides.length} slides, expected 38`);
if (htmlSlides.length !== 38) errors.push(`HTML has ${htmlSlides.length} slides, expected 38`);
...
for (let index = 0; index < markdownSlides.length; index += 1) {
  ...
  if (slide.number < 38 && !slide.block.includes("### 过渡")) {
...
console.log(
  `deck check passed: 38 slides, ${visualCount} explanatory visuals, aligned titles, complete notes, self-contained HTML`,
);
