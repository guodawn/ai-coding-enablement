...
if (markdownSlides.length !== 40) errors.push(`Markdown has ${markdownSlides.length} slides, expected 40`);
if (htmlSlides.length !== 40) errors.push(`HTML has ${htmlSlides.length} slides, expected 40`);
...
for (let index = 0; index < markdownSlides.length; index += 1) {
  ...
  if (slide.number < 40 && !slide.block.includes("### 过渡")) {
...
console.log(
  `deck check passed: 40 slides, ${visualCount} explanatory visuals, aligned titles, complete notes, self-contained HTML`,
);
