...
| 验证反馈 | Skill：证据责任 + tests / acceptance |
| 人类决策 | human gate：高影响取舍不由 AI 静默决定 |

**docs-for-ai 与 Skill 不是额外两项；它们是让四项条件可执行的两套机制。**

### 讲者备注

任务边界和人类决策由人保有；docs-for-ai 解决“资料该信谁”；Skill 将任务拆成可执行、可验证的过程。这样四项不是口号，而能落到仓库、路由、测试和验收中。
